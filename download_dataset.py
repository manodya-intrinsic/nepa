...
#     "abdomenct1k": {
#         "source": "kaggle",
#         "kaggle_dataset": "abdominalctsegmentation/",
#         "default_local_dir": "./data/AbdomenCT-1K",
#         "expected_extension": ".nii.gz",
#         "description": "AbdomenCT-1K 3D medical imaging dataset (1000 CT volumes)",
#     },
# }
...
# # def download_dataset_from_kaggle(kaggle_dataset: str, local_dir: str) -> str:
# #     """
# #     Download a dataset from Kaggle using Kaggle CLI.

# #     Args:
# #         kaggle_dataset: Kaggle dataset ID (e.g., "abdominalctsegmentation/")
...
# #     Raises:
# #         ImportError: If Kaggle CLI is not installed or configured.
...
# #         print("[INFO] Download API credentials from: https://www.kaggle.com/settings/account")
# #         print("[INFO] Place kaggle.json in ~/.kaggle/ directory")
# #         sys.exit(1)
...
# #         api.dataset_download_files(kaggle_dataset, path=local_dir, unzip=False)
...
#         description="Download a dataset using a preset (Hugging Face Hub or Kaggle)."
#     )
#     parser.add_argument(
#         "--dataset",
#         type=str,
...
#     print(f"[INFO] Description: {preset.get('description', 'N/A')}")

#     # Download based on source
#     if preset.get("source") == "kaggle":
#         kaggle_dataset = preset.get("kaggle_dataset")
#         print("[INFO] Source: Kaggle")
#         download_dataset_from_kaggle(kaggle_dataset, local_dir)
#     else:
#         repo_id = args.repo_id or preset.get("repo_id")
#         repo_type = preset.get("repo_type", "dataset")
#         print("[INFO] Source: Hugging Face Hub")
...
#         print(f"[INFO] Use with: --data_dir {local_dir}")
#         print("[INFO] Example with data_loader_3d_medical.py:")
#         print(f"       dataset = Medical3DDataset(root='{local_dir}', ...)")
#     else:
